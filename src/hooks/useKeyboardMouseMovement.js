...
const KeyCodeToAnimationKeyMap =
  new Map() <
  number >
  [
    // w
...
const handleKeyPress = (event) => {
  const activeAnimationKey = KeyCodeToAnimationKeyMap.get(event.keyCode)
}
...
export default function useKeyboardInput(inputManager, userKeyMap = {}) {
  ...
  useEffect(() => {
    inputManager.add('keydown', 'character-controls', downHandler)
